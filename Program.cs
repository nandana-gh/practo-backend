...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidIssuer = builder.Configuration["Jwt:Issuer"] ?? "practo_backend",
        ValidAudience = builder.Configuration["Jwt:Audience"] ?? "practo_frontend",
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Practo Clone API", Version = "v1" });
